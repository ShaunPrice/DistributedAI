...
from ..application.payments import ProviderEvent, PaymentProvider, StripeProvider, PayPalProvider  # noqa: F401
...
class BillingEngine:
    ...
    def _storage_size(sess: Session, org_id: str) -> int:
        from .workspace import Job, MemoryProposal, MemoryVersion, Message
        total = 0
